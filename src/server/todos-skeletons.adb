...
--
--  NOTE: This package is auto generated by the swagger code generator 2.3.0.
...
package body Todos.Skeletons is
   ...
   package body Skeleton is
      ...
      procedure Create_User
         ...
         Result : Todos.Models.User_Type;
      begin
         Swagger.Servers.Get_Parameter (Req, "username", Username);
         Swagger.Servers.Get_Parameter (Req, "password", Password);
         Impl.Create_User
            (Username,
