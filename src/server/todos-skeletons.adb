...
package body Todos.Skeletons is
   ...
   package body Skeleton is
      ...
      package API_Redirect_Todos is
         new Swagger.Servers.Operation (Handler => Redirect_Todos,
                                        Method  => Swagger.Servers.GET,
                                        URI     => URI_Prefix & "/");
      ...
      begin
         ...
         Swagger.Servers.Register (Server, API_Redirect_Todos.Definition);
   ...
   package body Shared_Instance is
      ...
      protected body Server is
         ...
         --  Redirect to the UI
         procedure Redirect_Todos (Context : in out Swagger.Servers.Context_Type) is
         begin
            Impl.Redirect_Todos (Context);
         end Redirect_Todos;
